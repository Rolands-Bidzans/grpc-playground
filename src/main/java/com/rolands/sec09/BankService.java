package com.rolands.sec09;

import com.google.common.util.concurrent.Uninterruptibles;
import com.rolands.models.sec09.*;
import com.rolands.sec09.repository.AccountRepository;
import com.rolands.sec09.validator.RequestValidator;
...
public class BankService extends BankServiceGrpc.BankServiceImplBase {
    ...
    public void getAccountBalance(BalanceCheckRequest request, StreamObserver<AccountBalance> responseObserver) {
        RequestValidator.validateAccount(request.getAccountNumber())
                ...
                .ifPresentOrElse(
                       responseObserver::onError, //  responseObserver.onError(Status.INVALID_ARGUMENT.asRuntimeException());
